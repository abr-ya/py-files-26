...
- [ ] T026b Update `clients/python/README.md` with runnable CLI upload examples using `--base-url`; update any current OpenSpec-routed docs instead of relying on `docs/legacy-specs/` as source of truth.
