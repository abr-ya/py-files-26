...
## Purpose
Define the accepted CLI authentication foundation, server-side resumable upload-session protocol, and CLI upload/status behavior for local `pyfiles` clients.
