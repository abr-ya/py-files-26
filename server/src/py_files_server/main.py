...
from py_files_server.api.routes import upload_sessions as upload_session_routes
...
api_router.include_router(upload_session_routes.router, prefix="/upload-sessions")
